...
// It contains the HTML head, styles, and the main page header.
...
<head>
    ...
    <style>
        /* All CSS from cinecraze.html is pasted here */
        :root {
            --primary: #e50914;
            --primary-dark: #b8070f;
            --secondary: #221f1f;
        ...
        * {
        ...
        /* ... (rest of the CSS from cinecraze.html) ... */
        .tab-content {
            display: none;
...
<body>
    <div class="container">
        <header>
            ...
            <p class="subtitle">Welcome, <?php echo htmlspecialchars($_SESSION['admin_username'], ENT_QUOTES, 'UTF-8'); ?>! Manage your content here.</p>
            <div style="position: absolute; top: 20px; right: 20px;">
                <a href="change_password.php" style="color:white; text-decoration: none; margin-right: 15px;">Change Password</a>
                <a href="logout.php" style="color:white; text-decoration: none;">Logout</a>
            </div>
        </header>

        <!-- Main content area will start here -->
